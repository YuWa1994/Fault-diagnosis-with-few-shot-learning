...
# ---------------------------------------------
#  few-shot learning with matching network
# ---------------------------------------------
...
for i in [0]:
    ...
    trainX, trainY = get_sample_data(trainX, trainY, num=10, classes=10) # randomly select a small number of training data
    ...
    ### Train Nets
    model = MN.Matching_net(trainX, trainY, n_epoch=1000, is_normalization=True)
